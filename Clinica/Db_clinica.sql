...
Select c.Data_Consulta, p.Nome_Paciente from tb_Consulta as c /* exibir tudo das tabelas*/
join tb_Paciente as p /*juntando (unindo) a tabela consulta com a tabela apciente */
